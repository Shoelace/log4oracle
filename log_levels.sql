...
COMMENT ON COLUMN log_levels.trace IS 'Log Level 0=disabled, >0 min number of days retention, <0 indefinite retention';
COMMENT ON COLUMN log_levels.debug IS 'Log Level 0=disabled, >0 min number of days retention, <0 indefinite retention';
COMMENT ON COLUMN log_levels.info  IS 'Log Level 0=disabled, >0 min number of days retention, <0 indefinite retention';
COMMENT ON COLUMN log_levels.warn  IS 'Log Level 0=disabled, >0 min number of days retention, <0 indefinite retention';
COMMENT ON COLUMN log_levels.error IS 'Log Level 0=disabled, >0 min number of days retention, <0 indefinite retention';
COMMENT ON COLUMN log_levels.fatal IS 'Log Level 0=disabled, >0 min number of days retention, <0 indefinite retention';
