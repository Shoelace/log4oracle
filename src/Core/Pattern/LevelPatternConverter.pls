...
create or replace 
type  LevelPatternConverter 
under    LogEventPatternConverter 
(
	--static function Convert(event LogEvent, value varchar2) return varchar2,
	
	constructor function LevelPatternConverter(options varchar2) return self as result,
...
create or replace 
type body LevelPatternConverter as
  ...
  BEGIN
	...
	constructor function LevelPatternConverter(options varchar2) return self as result is
	begin
