...
create or replace 
type body DatePatternConverter as
  ...
  BEGIN
	...
	constructor function DatePatternConverter(options varchar2) return self as result is
	begin
	...
	begin
		return to_char(event.getTimestamp(), 'yyyy-mm-dd hh24:mi:ss,ff3');
	end;
end;
/
show errors
