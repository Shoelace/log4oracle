...
create or replace 
type  LoggerPatternConverter 
under    LogEventPatternConverter 
(
	--static function Convert(event LogEvent, value varchar2) return varchar2,
	
	constructor function LoggerPatternConverter(options varchar2) return self as result,
...
create or replace 
type body LoggerPatternConverter as
  ...
  BEGIN
	...
	constructor function LoggerPatternConverter(options varchar2) return self as result is
	begin
