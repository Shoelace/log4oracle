...
prompt CREATE or replace TYPE ThreadContextContextStack

CREATE or replace TYPE ThreadContextContextStack
AUTHID DEFINER
AS OBJECT
(
...
prompt CREATE or replace TYPE BODY ThreadContextContextStack
